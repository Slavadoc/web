                ...
                <div class="w3-white w3-text-grey w3-card-4">
                                  <div class="w3-
                                   display-container">
                                       ...
                                       <img src="https://imgfon.ru/
                        Images/Details_img_880px/Animals/glaza-belyy_fon-kotik-morda-polosatyy.webp"
...
w                               3-text-black">
                         ...
                         fa-fw w3-margin-right w3-large w3-text-teal"></i>
                                          <?php echo $profi; ?>
                                        </p>
                                      ...
                                      <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>
                                        ...
                                        <p><i class="fa fa-envelope fa-fw w3-margin-rig
                          h     t w3-large w3-text-teal"></i>
                        ...
                        <h2 class="w3-text-grey w3-padding-16"><i
                          ...
                          <div class="w3-container">
                              <h5 class="w3-opacity"><b>
                                      <?php echo $expirience[0]['position']; ?>
                                   </b></h5>
                           <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                            <?php echo $expirience[0]['period']; ?><span class="w3-tag w3-teal w3-round">Current</span>
       
                 </h6>
                        <p>
                            <?php echo $expirience[0]['description']; ?>
                        </p>
                        <hr>
                    </div>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b>
                                <?php echo $expirience[1]['position']; ?>
                            </b></h5>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                            <?php echo $expirience[1]['period']; ?>
                        </h6>
                        <p>
                            <?php echo $expirience[1]['description']; ?>
                        </p>
                        <hr>
                    </div>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b>
                                <?php echo $expirience[2]['position']; ?>
                            </b></h5>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                            <?php echo $expirience[2]['period']; ?>
                        </h6>
                        <p>
                            <?php echo $expirience[2]['description']; ?>
                        </p><br>
                    </div>
                </div>
